<?php //netteCache[01]000367a:2:{s:4:"time";s:21:"0.23880300 1467792992";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:53:"F:\CMS\pear\data\ApiGen\templates\sublime\class.latte";i:2;i:1391390098;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:22:"released on 2013-12-31";}}}?><?php

// source file: F:\CMS\pear\data\ApiGen\templates\sublime\class.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'smbv96517g')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block title
//
if (!function_exists($_l->blocks['title'][] = '_lbb48913b8ee_title')) { function _lbb48913b8ee_title($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8e8a7c6a42_content')) { function _lb8e8a7c6a42_content($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbe117270098_children')) { function _lbe117270098_children($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb0a37b8f4a1_method')) { function _lb0a37b8f4a1_method($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb1209cbe58d_property')) { function _lb1209cbe58d_property($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
